...
- cut_number=3 뒤에는 인터미션 영상이 들어간다. 본론 설명은 cut_number=5 부터 시작한다.
...
- An intermission video is inserted after cut 3. Start the real body explanation from cut 5.
...
- The final audio file is padded to 5.0s locally; your job is only to make the spoken narration itself {min_sec}~{max_sec}s. Never write a line that needs more than {max_sec}s to speak.
...
- After cut 3, an intermission video is inserted.
