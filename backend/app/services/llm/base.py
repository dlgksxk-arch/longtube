  ...
  "cuts": [
    {
      "cut_number": 1,
      "narration": "...",
      "image_prompt": "영어로 된 시각 장면 설명만 작성, 읽을 수 있는 텍스트 금지",
      "visual_year": "보이는 장면의 정확한 연도 또는 좁은 날짜 범위. 예: '1592' 또는 'c. 1590-1591'",
      "visual_period": "구체적인 역사 시대 또는 현대 시기. 예: '인더스 문명, 성숙 하라파 시기, 기원전 약 2600-1900년'",
      "visual_location": "구체적인 장소 또는 환경. 예: '모헨조다로 배수로 근처 벽돌 거리'",
      "visual_evidence": "이 이미지가 내레이션과 시대에 맞는 이유를 짧게 한 문장으로 작성",
...
- 슬로건처럼 짧은 문장은 쓰지 마세요. 각 내레이션은 구체적인 디테일이 포함된 완전한 한 호흡의 생각이어야 합니다.
- 유효한 컷은 제목 카드처럼 느껴지면 안 되고, 거의 5초 전체를 말로 채우는 느낌이어야 합니다.
...
- visual_period는 구체적이어야 하며 일반적이면 안 됩니다. 역사에서는 가능하면 시대, 통치자/왕조/문화, 날짜 범위를 적으세요.
- visual_location은 일반 배경이 아니라 구체적인 공간이어야 합니다.
- visual_evidence는 내레이션과 이미지의 연결 이유를 짧게 설명해야 합니다.
- image_prompt는 캐릭터나 행동보다 먼저 보이는 연도/날짜 범위와 정확한 공간으로 시작해야 합니다. 필수 형식: "Year/period: ...; Exact place: ...; Scene: ..."
