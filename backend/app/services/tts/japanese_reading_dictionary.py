...
# Only verified source/readings belong here. The preflight uses these entries to
# reject an explicit kana track that no longer reads the subtitle source.
JAPANESE_TTS_READING_GUARDS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("三種の神器", ("さんしゅのじんぎ", "みくさのたから", "みくさのかむたから", "みくさのかむだから")),
    ("オオクニヌシ", ("おおくにぬし",)),
    ("野見宿禰", ("のみのすくね",)),
    ("御家人", ("ごけにん",)),
    ("大火傷", ("おおやけど",)),
